...
dataloader = torch.utils.data.DataLoader(dataset = dataset, batch_size = batchSize, shuffle = True, num_workers = 2)

# Definning weights_init
def weights_init(m):
...
for epoch in range(25):
    for i, data in enumerate(dataloader, 0):
        ...
        # Step 1: updating the weights of discriminator
